...
def main():
    ...
    with db_connector.get_session() as session:
        ...
        rol = service.save_rol(usuario_id=1, sesion_id=None, data=rol_data)
        session.flush()
        ...
        mun = service.save_municipio(usuario_id=1, sesion_id=None, data=mun_data)
        session.flush()
        ...
        loc = service.save_localizador(usuario_id=1, sesion_id=None, data=loc_data)
        session.flush()
