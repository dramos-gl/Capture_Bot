...
- **Esquema de Base de Datos**: Respetar el diseño físico de PostgreSQL detallado en [10_SAR-DB-001 v2.0.md](file:///c:/Users/dramos/Documents/Proyecto_CapturaBot/sar/doc_sar/10_SAR-DB-001%20v2.0.md) e implementar control transaccional estricto con bloqueos a nivel de fila (FOR UPDATE) cuando se gestionen folios/consecutivos concurrentes.
